...
products = {
    1: {'name': 'Cocktail', 'sizes': {'Small': 7, 'Medium': 10, 'Large': 12}},
    2: {'name': 'Pineging', 'sizes': {'Small': 7, 'Medium': 10, 'Large': 12}},
    3: {'name': 'Citruswave', 'sizes': {'Small': 7, 'Medium': 10, 'Large': 12}},
    4: {'name': 'Tropifusion', 'sizes': {'Small': 7, 'Medium': 10, 'Large': 12}},
    5: {'name': 'Waterpine', 'sizes': {'Small': 7, 'Medium': 10, 'Large': 12}},
    6: {'name': 'Crimson Carrot', 'sizes': {'Small': 10, 'Medium': 12, 'Large': 15}},
    7: {'name': 'Banapple', 'sizes': {'Small': 7, 'Medium': 10, 'Large': 15}},
    8: {'name': 'Beetro-Pine', 'sizes': {'Small': 10, 'Medium': 12, 'Large': 15}},
    9: {'name': 'Nutwave', 'sizes': {'Small': 10, 'Medium': 12, 'Large': 15}},
}
